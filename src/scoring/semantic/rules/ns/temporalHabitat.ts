...
export function scoreTemporalHabitatByPromptType(
  transcript: string,
...
function scoreTemporalHabitatFreeRecall(transcriptRaw: string): SubAxisScore {
...
function scoreTemporalHabitatNeutral(): SubAxisScore {
  return buildTemporalHabitatScore(0.5, 0.25, []);
}

function temporalHabitatConfidence(
  totalSignals: number,
  multiplier: number,
  base = 0.26,
  step = 0.05,
...
function buildTemporalHabitatScore(score: number, confidence: number, cues: any[]): SubAxisScore {
  return {
