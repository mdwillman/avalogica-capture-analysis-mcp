...
export function scoreInformationDietByPromptType(
  transcript: string,
...
function scoreInformationDietFreeRecall(transcriptRaw: string): SubAxisScore {
...
function scoreInformationDietNeutral(): SubAxisScore {
  return buildInformationDietScore(0.5, 0.25, []);
}

function informationDietConfidence(
  totalSignals: number,
  multiplier: number,
  base = 0.26,
  step = 0.05,
...
function buildInformationDietScore(score: number, confidence: number, cues: any[]): SubAxisScore {
  return {
