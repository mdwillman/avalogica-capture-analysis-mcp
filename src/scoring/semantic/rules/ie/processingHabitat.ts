...
function processingHabitatConfidence(
  totalSignals: number,
  multiplier: number,
  base = 0.26,
  step = 0.05,
...
export function scoreProcessingHabitatByPromptType(
  transcript: string,
...
function scoreProcessingHabitatFreeRecall(transcriptRaw: string): SubAxisScore {
...
function scoreProcessingHabitatNeutral(): SubAxisScore {
  return buildProcessingHabitatScore(0.5, 0.25, []);
}

function buildProcessingHabitatScore(score: number, confidence: number, cues: any[]): SubAxisScore {
  return {
