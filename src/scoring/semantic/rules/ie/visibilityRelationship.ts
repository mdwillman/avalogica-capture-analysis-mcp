...
export function scoreVisibilityRelationshipByPromptType(
  transcript: string,
...
function scoreVisibilityRelationshipFreeRecall(transcriptRaw: string): SubAxisScore {
...
function scoreVisibilityRelationshipNeutral(): SubAxisScore {
  return buildVisibilityRelationshipScore(0.5, 0.25, []);
}

function buildVisibilityRelationshipScore(score: number, confidence: number, cues: any[]): SubAxisScore {
  return {
