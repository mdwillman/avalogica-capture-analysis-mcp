 ...
 */
export function scoreJPClosureDrive(transcriptRaw) {
 ...
 * Reminder: JP mapping is low=J, high=P.
 */
export function scoreJPStructureRelationship(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 * Reminder: JP mapping is low=J, high=P.
 */
export function scoreJPCommitmentMetabolism(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 * Reminder: JP mapping is low=J, high=P.
 */
export function scoreJPTemporalOrientationToPlans(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 * Reminder: JP mapping is low=J, high=P.
 */
export function scoreJPCompletionRelationship(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
