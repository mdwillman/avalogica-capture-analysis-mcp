 ...
 */
export function scoreNSAttentionPlane(transcriptRaw) {
 ...
 */
export function scoreNSTemporalHabitat(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 *   score01 = 1.0 => S
 */
export function scoreNSInformationDiet(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 *   score01 = 1.0 => S
 */
export function scoreNSRealityRelationship(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
 ...
 *   score01 = 1.0 => S
 */
export function scoreNSMeaningThreshold(transcriptRaw) {
    const analysis = analyzeTextForScoring(transcriptRaw || "");
    const t = (analysis.primaryText || "").toLowerCase();
