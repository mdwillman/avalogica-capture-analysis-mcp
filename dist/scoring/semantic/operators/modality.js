...
export function summarizeModality(text, opts) {
 ...
 */
export function modalityConfidenceMultiplier(strengthIndex) {
 ...
 */
export function volitionalCommitmentIndex(summary) {
